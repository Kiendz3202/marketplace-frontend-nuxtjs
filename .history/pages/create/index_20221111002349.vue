  ...
  methods: {
    ...
    async addProduct(e) {
      ...
      try {
        ...
        // const nftinformation = await marketplace._listings(id);
        ...
        const nftInfo = {
          name: "nft first",
          description: "nft first des",
          price: "100",
          image: `https://cloudflare-ipfs.com/ipfs/bafybeieh4sjsol5jgiae7wvtny3tzak7jd7pblnie2wz4wdwb7w3rbeb3a/275354751_303765415186729_415228544294433718_n.jpg`,
          itemId: "1",
          tokenId: "1",
        ...
        const response = await fetch("http://localhost:5000/savenftinfo", {
          method: "POST",
          body: JSON.stringify({
            uri: "https://cloudflare-ipfs.com/ipfs/bafyreidnwwkvl6zpa7usel6ctauvbf4fw2avskbgeeyw6pqqizzyjioy3m/metadata.json",
            nftInfo,
          }),
          headers: {
