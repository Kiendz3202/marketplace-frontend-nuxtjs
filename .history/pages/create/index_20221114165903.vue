  ...
  methods: {
    ...
    async addProduct(e) {
      ...
      try {
        ...
        // // add nft to marketplace
        // await (
        //   await marketplace.listNFT(nft.address, id, metadataResult.price)
        // ).wait();
        console.log("start");
        const nftinformation = await marketplace._listings(8);
        console.log(nftinformation);
        console.log(nftinformation.itemId.toNumber());
        console.log(nftinformation.tokenId.toNumber());
        console.log("done");

        // const nftInfo = {
        //   name: metadataResult.name,
        //   description: metadataResult.description,
        //   price: metadataResult.price,
        //   image: `https://cloudflare-ipfs.com/ipfs/${metadataResult.image.substring(
        //     7
        //   )}`,
        //   itemId: nftinformation.itemId.toNumber(),
        //   tokenId: nftinformation.tokenId.toNumber(),
        //   nft: nftinformation.nft,
        //   seller: nftinformation.seller,
        //   sold: nftinformation.sold,
        //   buyer: "",
        // };

        const nftInfo = {
          name: "meme bk",
          description: "meme bk des",
          price: "200",
          image: `https://cloudflare-ipfs.com/ipfs/bafybeig3l2nkp2b2mevi4vtkh6v2d4z55oq27go6rcu3f6jwg5e2g3j5am/286097694_1084479535494138_4702386285705682570_n.png`,
          itemId: 8,
          tokenId: 8,
          nft: "0xb60461d9A4a71bfCB3A24F0fFbfCb157B3A5cb9b",
          seller: "0xF0F28D1dFBacB7ec33928fea7864bEA695cA7863",
          sold: false,
          buyer: "",
        };
        const uri =
          "https://cloudflare-ipfs.com/ipfs/bafyreieljww4dmuv4neebpogz45ojbc2eraiswj5pyuhkau25dxx5x2p5a/metadata.json";

        const response = await fetch("http://localhost:5000/savenftinfo", {
          method: "POST",
          body: JSON.stringify({
            uri: uri,
            nftInfo,
