  ...
  methods: {
    ...
    async addProduct(e) {
      ...
      try {
        ...
        const nftInfo = {
          name: "Kute cat",
          description: "kute cat des",
          price: "200",
          image: `https://cloudflare-ipfs.com/ipfs/bafybeibfn2m2aztwhbglpt5hb46djsftibjcmjvtybzgveg32vdul5mc7y/anh-meo-cute-nhat-9.jpg`,
          itemId: "2",
          tokenId: "2",
          nft: "0xb60461d9A4a71bfCB3A24F0fFbfCb157B3A5cb9b",
          seller: "0x707853aF33De5d3E95d6580918e180A59261B75e",
          sold: false,
        };
        ...
        const response = await fetch("http://localhost:5000/savenftinfo", {
          method: "POST",
          body: JSON.stringify({
            uri: "https://cloudflare-ipfs.com/ipfs/bafyreidsl34sfteykj7qfesussrpogn6jqip577pa3sswyvgjttdg6hn5a/metadata.json",
            nftInfo,
          }),
          headers: {
