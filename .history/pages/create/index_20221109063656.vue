    ...
    async addProduct(e) {
      ...
      try {
        const metadata = await client.store({
          ...
          price: this.price,
          image:
            "https://scontent.fhan5-9.fna.fbcdn.net/v/t39.30808-6/296669483_1122491728479771_5545200215383782052_n.jpg?_nc_cat=109&ccb=1-7&_nc_sid=09cbfe&_nc_ohc=jTu35-Xh5_IAX9R9Lve&_nc_ht=scontent.fhan5-9.fna&oh=00_AfDSuCNZuIdhePJo8B3p4Lic7FsE-QpGzSA8kyqiksFcOQ&oe=63702D28",
        });
        console.log(metadata);
        // this.mintThenList(metadata);
        // const res = await fetch("http://localhost:5000/mintnft", {
        //   method: "POST",
