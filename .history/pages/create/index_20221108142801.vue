<template>
  <form @submit="addProduct">
    <input v-model="name" placeholder="Name" class="rounded-md pl-3" />
    <input v-model="description" placeholder="Description" class="rounded-md" />
    <input v-model="price" placeholder="Price" class="rounded-md" />
