<template>
  ...
  >
    ...
    <button
      class="group flex h-16 items-center justify-center bg-black text-lg font-semibold text-white cursor-none cursor-pointer"
      v-bind:class="['{{displayBuying}}' ? 'cursor-pointer' : 'cursor-none']"
      @click="onButtonClick"
      :disabled="loading"
    >
